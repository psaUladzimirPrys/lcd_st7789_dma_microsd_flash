...
typedef enum {
  SPI_SLAVE_CHIP_SELECT_LOW = 0,  //Slave select CS level low
  SPI_SLAVE_CHIP_SELECT_HIGH,    //Slave select CS level high

  SPI_SLAVE_CHIP_SELECT_DEFAULT =
      SPI_SLAVE_CHIP_SELECT_HIGH
} spi_slave_chip_select_t;
...
err_t spi_master_control_cs(spi_master_t *obj, 
                            spi_slave_chip_select_t obj_cs);
